...
import com.cobamvvm.project.Utils.RequestInterceptor
import com.cobamvvm.project.Utils.UnsafeOkHttpClient
...
val apiDataSourceDependency = applicationContext {
    ...
    bean { provideApiDataSource(get(), get()) }
